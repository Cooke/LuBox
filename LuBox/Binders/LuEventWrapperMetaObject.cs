namespace LuBox.Runtime
{
    ...
    internal class LuEventWrapperMetaObject : DynamicMetaObject
    {
        ...
        {
            BindingRestrictions eventWrapperTypeRestriction = BindingRestrictions.GetTypeRestriction(Expression, typeof (EventWrapper));
            ...
            return new DynamicMetaObject(ResultHelper.EnsureObjectResult(Expression.Call(instanceExpression, methodInfo, argExpression)), RestrictionHelper.CombineRestrictions(eventWrapperTypeRestriction, eventRestriction));
        }
    }
}